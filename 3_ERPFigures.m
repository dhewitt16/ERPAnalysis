...
plottingTimesSelected = [150 200]; %150 200 fir N140; 230 300 P300 for stats exports and topographies
selectedElectrode = {'FC1','FCz','FC2'}; % 'FC1','FCz','FC2' for N140, 'Cz' for P300;  multiple electrodes can be specified
%========================================================================
